        ...
        <tr>
            <td colspan="6" style="border-bottom: 1px solid black;">
                <table border="0" width="100%">   
                    ...
                    <tr>
                        <td style="font-size: 90%; width:50%">{{strtoupper($transaksi->dokter->nama) }}</td>                                       
                    </tr>                                                     
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="6" style="border-bottom: 1px solid black;">
                <table border="0" width="100%">   
                    ...
                    <tr>
                        <td style="font-size: 90%; width:50%">{{strtoupper($transaksi->pasien->nama) }}</td>                                       
                    </tr>
                    <tr>
                        <td style="font-size: 70%;width:10%">
                            @if ($transaksi->pasien->jenis_kelamin == 'L')
                                <span>Laki-Laki</span>
                            @else
                                <span>Perempuan</span>
                            @endif
                             , {{\Carbon\Carbon::parse($transaksi->pasien->tanggal_lahir)->format('d F Y')}}</td>                
                    </tr>                                      
                </table>
            </td>
        </tr>
