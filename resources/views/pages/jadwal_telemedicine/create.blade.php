...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form role="form" action="{{route('dokter.jadwaltelemedicine.store')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="Ruangan">Nominal</label>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('dokter.jadwaltelemedicine') }}"><button id="buttonCancel" type="button"
