        ...
        <div class="container">
            <div class="card">
                ...
                @endif --}}
                    ...
                    <form role="form" action="{{ route('user_apoteker.update', $admin->id) }}" method="POST">
                        @csrf @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nik" type="text" class="form-control" id="TempatLahir"
                                    placeholder="Masukkan NIK" required value="{{$admin->users->nik}}">
                            </div>
                            <div class="form-group">
