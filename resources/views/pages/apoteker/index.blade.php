        ...
        <div class="card">
            <div class="row card-header">
                <div class="col-sm-2 col-12">
                    <a href="{{route('user_apoteker.create')}}"><button type="button" id="buttonTambahUserAdmin" class="btn btn-block btn-primary">Tambah
                        Apoteker</button></a>
                </div>
            </div>
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('user_apoteker.edit', $item->id)}}">
                                    <button type="button" class="btn btn-warning">Edit</button>
                                </a>
                                {{-- <a href="{{route('user_apoteker.edit', $item->id)}}">
                                    <button type="badge" class="bg bg-warning border-0">Ganti Password</button>
                                </a> --}}
                                <form style="margin-top: 5px;display:inline-block;" action="{{route('user_apoteker.destroy', $item->id)}}"
                                    method="POST">
                                    @csrf   
                                    @method("DELETE")
