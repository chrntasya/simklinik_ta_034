        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
              <i class="far fa-bell"></i>  <span>|</span> {{auth()->user()->nama}}
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              @foreach (auth()->user()->unreadNotifications as $item)
                ...
                <a href="#" class="dropdown-item">
                  ...
                  {{-- <span class="float-right text-muted text-sm">{{\Carbon\Carbon::parse($item->created_at)->format('Y/m/d')}}</span> --}}
                </a>      
              @endforeach
              <div class="dropdown-divider"></div>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item ">
                  <a href="{{ route('transaksi.listrekammedis') }}" class="nav-link {{ request()->is('admin/transaksi*') || request()->is('admin/listrekammedis*') ? ' active' : ''}}">
