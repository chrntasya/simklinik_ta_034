    ...
    <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            {{-- <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              @foreach (auth()->user()->unreadNotifications as $item)
                ...
                <a href="#" class="dropdown-item">
                  <i class="fas fa-medkit mr-2"></i> {{$item->data['text']}}                  
                </a>      
              @endforeach
              <div class="dropdown-divider"></div>
              <a href="{{ route('apoteker.deletenotifikasi') }}" class="dropdown-item text-center">
                 Hapus Notification                
              </a>                     
            </div> --}}
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i class="fas fa-cog"></i> {{auth()->user()->nama}}
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              <div class="dropdown-divider"></div>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item ">
                  <a href="{{ route('lab.listrujukan') }}" class="nav-link {{ request()->is('laboratorium/listrujukan*') || request()->is('laboratorium/listrujukan*') ? ' active' : ''}}">
                ...
                <li class="nav-item ">
                  <a href="{{ route('lab.index') }}" class="nav-link {{ request()->is('laboratorium/index*') || request()->is('laboratorium/index*') ? ' active' : ''}}">
                  ...
                  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src="{{ asset('bantuan/apoteker/13.jpg') }}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="{{ asset('bantuan/apoteker/14.jpg') }}" alt="Second slide">
                        </div>                      
                      </div>
